...
const ContactHero = () => {
  return (
    ...
    <section className="relative w-full h-auto min-h-[70vh]  sm:h-screen  flex flex-col justify-center items-center text-center px-4 sm:px-6 pt-8  sm:pt-16 pb-6">
          ...
          <h2 className="md:text-4xl text-[24px] font-space font-semibold  leading-tight text-black-800">
            <motion.div
      initial={{ opacity: 0, x: -50 }}
          ...
          className="block">
            ...
            <span className="text-black ">
              <motion.span
                        ...
                        className="block pl-20"
                      >{" "}
              <span className="bg-gradient-to-l from-[#FF960B] pr-14">
                 Unique *
              </span>{" "}
              </motion.span>
            </span>
          ...
          <p className="pt-13 text-lg text-gray-600">
                  <motion.p
